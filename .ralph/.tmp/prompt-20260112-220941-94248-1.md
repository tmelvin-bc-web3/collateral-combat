...
4. Read /Users/taylermelvin/Desktop/sol-battles/.ralph/IMPLEMENTATION_PLAN.md and locate the section for US-003.
   - If no section exists, create `### US-003: Frontend Types and Client` and add the tasks needed.
...
7. Implement only the tasks that belong to US-003.
...
9. Update /Users/taylermelvin/Desktop/sol-battles/.ralph/IMPLEMENTATION_PLAN.md:
   ...
   - Add notes or new tasks only within the US-003 section.
10. Update the PRD:
   - Check off **all acceptance criteria** for US-003 (`- [x]`) once verified.
   - Only after all acceptance criteria are checked, mark the story heading as complete
     (change `### [ ] US-003:` to `### [x] US-003:`).
...
```
## [Date/Time] - US-003: Frontend Types and Client
