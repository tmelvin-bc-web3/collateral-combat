...
must_haves:
  truths:
    - "User sees real-time PnL delta visualization during battle"
    - "User can tell at a glance who is winning the battle"
    - "User sees danger warning when close to losing"
    - "User sees their own PnL and opponent PnL numbers"
  artifacts:
