...
<objective>
Build challenge board UI for viewing and creating challenges

Purpose: Per CONTEXT.md, create a dedicated challenge board page where users can see open challenges and create their own. Also integrate a quick-preview sidebar on the battle page.
Output: Challenge board page, challenge card components, create challenge modal
</objective>
...
TypeScript compiles: `cd web && pnpm typecheck`
  ...
  <done>
useChallenges hook fetches challenges, subscribes to WebSocket updates, and provides createChallenge function
  </done>
</task>
...
<task type="auto">
  <name>Task 3: Create challenges page</name>
  <files>
    web/src/app/challenges/page.tsx
  </files>
  <action>
...
export default function ChallengesPage() {
  ...
  const handleAccept = async (code: string) => {
    ...
    // Navigate to battle page with challenge code
...
Build succeeds: `cd web && pnpm build`
  ...
  <done>
/challenges page shows challenge board, direct challenges alert, and create modal
  </done>
</task>

<task type="checkpoint:human-verify" gate="blocking">
  <what-built>Challenge board page with listing, filtering, creation, and direct challenges</what-built>
  <how-to-verify>
...
6. Direct challenges appear in prominent alert banner
7. Real-time updates via WebSocket when new challenges created
</success_criteria>
