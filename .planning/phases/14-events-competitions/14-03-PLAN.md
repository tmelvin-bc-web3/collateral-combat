...
**Pre-existing infrastructure note:** The notificationDatabase.ts file already exists from Phase 12
(Progression System). This plan extends it with new notification types for events and tournaments.
The file contains the createNotification helper and NotificationType union that we will extend.
</context>
