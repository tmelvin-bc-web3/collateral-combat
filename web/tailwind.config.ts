...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'rust-gradient':
          'linear-gradient(135deg, #5c2e0d 0%, #8b4513 50%, #5c2e0d 100%)',
        'fire-gradient':
          'linear-gradient(180deg, #e63900 0%, #ff5500 50%, #cc2200 100%)',
        'dome-gradient':
          'radial-gradient(ellipse at center, #151210 0%, #080705 70%)',
        'metal-gradient':
          'linear-gradient(180deg, #3a3a3a 0%, #2a2a2a 50%, #1a1a1a 100%)',
        wasteland:
          'linear-gradient(180deg, rgba(8,7,5,0.95) 0%, rgba(21,18,16,0.9) 100%)',
      },
      boxShadow: {
