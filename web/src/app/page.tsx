...
import { UpcomingFightNight } from '@/components/fightcard';
...
const MOCK_DATA: HomepageData = {
  ...
  events: {
    ...
    nextEventName: 'Weekly Championship',
    nextEventTime: Date.now() + 86400000, // 24 hours from now
  },
  recentActivity: [],
  platformStats: {
    totalGames: 12453,
  ...
  return (
    <>
      <div className="max-w-6xl mx-auto animate-fadeIn">
        ...
        {/* Upcoming Fight Night - UFC style event card */}
        <UpcomingFightNight />
      ...
      <FloatingActivityFeed activities={homepageData.recentActivity} />
    </>
  );
}
