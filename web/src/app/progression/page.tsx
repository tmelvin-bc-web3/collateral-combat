    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 animate-fadeIn">
      ...
      <div className="mb-6 sm:mb-8 mt-6 sm:mt-8">
        <div className="flex items-center gap-3 mb-2">
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight uppercase" style={{ fontFamily: 'Impact, sans-serif' }}>
      ...
      {/* Tabs */}
      <div className="flex gap-1 mb-6 sm:mb-8 p-1 sm:p-1.5 bg-bg-secondary rounded-xl border border-rust/20">
        {(['overview', 'rewards', 'perks'] as const).map((tab) => (
          <button
            key={tab}
            onClick={() => setActiveTab(tab)}
            className={cn(
              'flex-1 px-2 sm:px-4 py-2 sm:py-2.5 rounded-md font-semibold text-xs sm:text-sm uppercase tracking-wider transition-all',
              activeTab === tab
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6 sm:space-y-8">
          ...
          <div className="card border border-rust/30">
            <h2 className="text-lg sm:text-xl font-black mb-3 sm:mb-4 uppercase tracking-wide">How XP Works</h2>
              ...
              {XP_SOURCES.map((source) => (
                ...
                >
                  <div className="flex items-start gap-2 sm:gap-3">
                    <div className={cn('p-1.5 sm:p-2 rounded-lg flex-shrink-0', source.bgColor, source.color)}>
                      {source.icon}
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2 mb-1">
                        <h3 className={cn('font-bold text-sm sm:text-base truncate', source.color)}>{source.name}</h3>
                        <span className="text-[10px] sm:text-xs font-mono text-text-tertiary whitespace-nowrap">{source.xpRange}</span>
                      </div>
                      <p className="text-xs sm:text-sm text-text-secondary">{source.description}</p>
                    </div>
                  </div>
                </div>
              ))}
          ...
          {/* Level Tiers */}
          <div className="card border border-rust/30">
            <h2 className="text-lg sm:text-xl font-black mb-3 sm:mb-4 uppercase tracking-wide">Rank Tiers</h2>
            <p className="text-sm sm:text-base text-text-secondary mb-4 sm:mb-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2 sm:gap-3">
              {LEVEL_TIERS.map((tier) => (
                <div
                  key={tier.title}
                  className="text-center p-2.5 sm:p-4 rounded-lg bg-bg-tertiary border border-rust/20"
                >
                  <div className="flex justify-center mb-1.5 sm:mb-2">
                    <LevelBadge level={tier.maxLevel} size="lg" />
                  </div>
                  <h3 className={cn('font-bold text-xs sm:text-sm', tier.textColor)}>{tier.title}</h3>
          ...
          <div className="card border border-fire/30 bg-fire/5">
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-fire/20 flex items-center justify-center flex-shrink-0">
                <span className="text-lg sm:text-xl">🔥</span>
              </div>
              <div className="min-w-0">
                <h2 className="text-base sm:text-xl font-black text-fire uppercase tracking-wide">Daily Streak Bonuses</h2>
                <p className="text-[10px] sm:text-xs text-text-tertiary">Play daily to earn bonus XP</p>
              </div>
            </div>
            ...
            {walletAddress && streak && (
              <div className="mb-4 sm:mb-6 p-3 sm:p-4 rounded-lg bg-bg-tertiary border border-fire/20">
                <div className="flex items-center justify-between gap-4">
                  <div className="min-w-0">
                    <p className="text-[10px] sm:text-xs text-text-tertiary uppercase tracking-wider mb-1">Your Current Streak</p>
                    <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                      <span className="text-2xl sm:text-3xl font-black text-fire">{streak.currentStreak}</span>
                      <span className="text-sm sm:text-base text-text-secondary">days</span>
                      {streak.bonusPercent > 0 && (
                        <span className="px-1.5 sm:px-2 py-0.5 sm:py-1 rounded bg-fire/20 text-fire text-xs sm:text-sm font-bold">
                  ...
                  <div className="text-right flex-shrink-0">
                    <p className="text-[10px] sm:text-xs text-text-tertiary uppercase tracking-wider mb-1">Longest</p>
                    <span className="text-xl sm:text-2xl font-bold text-text-secondary">{streak.longestStreak}</span>
                  </div>
                </div>
              </div>
            )}
              ...
              {STREAK_BONUSES.slice().reverse().map((tier, idx) => {
                ...
                return (
                  <div
                    key={tier.minDays}
                    className={cn(
                      'text-center p-2 sm:p-4 rounded-lg border transition-all',
                      isCurrentTier
                  ...
                  >
                    <div className={cn(
                      'text-lg sm:text-2xl font-black mb-0.5 sm:mb-1',
                    ...
                    {isCurrentTier && (
                      <div className="mt-1 sm:mt-2 text-[8px] sm:text-[10px] text-fire font-bold uppercase">Current</div>
                    )}
                  </div>
                );
              })}
            ...
            <div className="mt-3 sm:mt-4 p-2 sm:p-3 rounded-lg bg-fire/10 border border-fire/20">
              <p className="text-[10px] sm:text-xs text-fire">
      ...
      {activeTab === 'rewards' && (
        <div className="space-y-4 sm:space-y-6">
          <div className="card border border-rust/30">
            <h2 className="text-lg sm:text-xl font-black mb-3 sm:mb-4 uppercase tracking-wide">Level Rewards</h2>
            <p className="text-sm sm:text-base text-text-secondary mb-4 sm:mb-6">
            ...
            <div className="space-y-3 sm:space-y-4">
              {LEVEL_REWARDS.map((milestone) => (
                <div
                  key={milestone.level}
                  className="flex items-start sm:items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-lg bg-bg-tertiary border border-rust/20"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-wrap gap-1.5 sm:gap-2">
                      {milestone.rewards.map((reward, idx) => (
                        ...
                        >
                          <span className="text-sm sm:text-base">{reward.icon}</span>
                          <span className="truncate">{reward.name}</span>
                          {reward.permanent && (
                            <span className="text-[10px] sm:text-xs bg-green-500/30 text-green-400 px-1 sm:px-1.5 py-0.5 rounded whitespace-nowrap">
                              Forever
                            </span>
                          )}
                        </div>
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="card border border-amber-500/30 bg-amber-500/5">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                ...
                <div className="min-w-0">
                  <h2 className="text-base sm:text-lg font-black text-amber-400 uppercase">Oracle Perks</h2>
                  <p className="text-[10px] sm:text-xs text-text-tertiary">Base rake: 5%</p>
                </div>
              </div>
              ...
              <div className="space-y-1.5 sm:space-y-2">
                <div className="flex items-center justify-between p-2 sm:p-3 rounded-lg bg-bg-tertiary">
                  <span className="text-xs sm:text-sm text-text-secondary">Level 15, 25</span>
                  <span className="font-bold text-amber-400 text-sm sm:text-base">4.5% rake</span>
                </div>
                <div className="flex items-center justify-between p-2 sm:p-3 rounded-lg bg-bg-tertiary">
                  <span className="text-xs sm:text-sm text-text-secondary">Level 40, 50</span>
                  <span className="font-bold text-amber-400 text-sm sm:text-base">4% rake</span>
                </div>
                <div className="flex items-center justify-between p-2 sm:p-3 rounded-lg bg-bg-tertiary">
                  <span className="text-xs sm:text-sm text-text-secondary">Level 75, 100</span>
                  <span className="font-bold text-amber-400 text-sm sm:text-base">3.5% rake</span>
                </div>
              </div>
            </div>
            ...
            <div className="card border border-purple-500/30 bg-purple-500/5">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                ...
                <div className="min-w-0">
                  <h2 className="text-base sm:text-lg font-black text-purple-400 uppercase">Draft Perks</h2>
                  <p className="text-[10px] sm:text-xs text-text-tertiary">Base rake: 10%</p>
                </div>
              </div>
              ...
              <div className="space-y-1.5 sm:space-y-2">
                <div className="flex items-center justify-between p-2 sm:p-3 rounded-lg bg-bg-tertiary">
                  <span className="text-xs sm:text-sm text-text-secondary">Level 15, 25</span>
                  <span className="font-bold text-purple-400 text-sm sm:text-base">9% rake</span>
                </div>
                <div className="flex items-center justify-between p-2 sm:p-3 rounded-lg bg-bg-tertiary">
                  <span className="text-xs sm:text-sm text-text-secondary">Level 40, 50</span>
                  <span className="font-bold text-purple-400 text-sm sm:text-base">8% rake</span>
                </div>
                <div className="flex items-center justify-between p-2 sm:p-3 rounded-lg bg-bg-tertiary">
                  <span className="text-xs sm:text-sm text-text-secondary">Level 75, 100</span>
                  <span className="font-bold text-purple-400 text-sm sm:text-base">7% rake</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card border border-green-500/30 bg-green-500/5">
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              ...
              <div className="min-w-0">
                <h2 className="text-base sm:text-lg font-black text-green-400 uppercase">Free Wagers</h2>
                <p className="text-[10px] sm:text-xs text-text-tertiary">Bonus predictions at milestones</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5 sm:gap-2">
              ...
              <div className="text-center p-2 sm:p-3 rounded-lg bg-bg-tertiary">
                ...
                <p className="text-[10px] sm:text-xs text-text-tertiary">Level 10</p>
              </div>
              <div className="text-center p-2 sm:p-3 rounded-lg bg-bg-tertiary">
                <span className="text-base sm:text-lg font-bold text-green-400">3</span>
                <p className="text-[10px] sm:text-xs text-text-tertiary">Level 20</p>
              </div>
              <div className="text-center p-2 sm:p-3 rounded-lg bg-bg-tertiary">
                <span className="text-base sm:text-lg font-bold text-green-400">3</span>
                <p className="text-[10px] sm:text-xs text-text-tertiary">Level 35</p>
              </div>
            </div>
          ...
          {/* How Perks Work */}
          <div className="card border border-rust/30">
            <h2 className="text-lg sm:text-xl font-black mb-3 sm:mb-4 uppercase tracking-wide">How Perks Work</h2>

            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-accent/20 flex items-center justify-center text-accent font-bold flex-shrink-0 text-sm sm:text-base">
                  1
                </div>
                <div className="min-w-0">
                  <h3 className="font-bold text-text-primary mb-0.5 sm:mb-1 text-sm sm:text-base">Unlock at Milestones</h3>
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="min-w-0">
                  <h3 className="font-bold text-text-primary mb-0.5 sm:mb-1 text-sm sm:text-base">Stack Your Savings</h3>
                  <p className="text-xs sm:text-sm text-text-secondary">
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-success/20 flex items-center justify-center text-success font-bold flex-shrink-0">
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                </div>
                <div className="min-w-0">
                  <h3 className="font-bold text-success mb-0.5 sm:mb-1 text-sm sm:text-base">Level 100 = Permanent</h3>
                  <p className="text-xs sm:text-sm text-text-secondary">
          ...
          {/* Savings Calculator */}
          <div className="card border border-rust/30">
            <h2 className="text-lg sm:text-xl font-black mb-3 sm:mb-4 uppercase tracking-wide">Savings Example</h2>
            ...
            <div className="block sm:hidden space-y-3">
              <div className="p-3 rounded-lg bg-bg-tertiary border border-rust/20">
                <p className="text-xs text-text-primary mb-2 font-medium">100 Oracle predictions @ 0.1 SOL</p>
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div>
                    <p className="text-[10px] text-text-tertiary">Base</p>
                    <p className="text-sm font-mono text-danger">0.5 SOL</p>
                  </div>
                  <div>
                    <p className="text-[10px] text-text-tertiary">With Perk</p>
                    <p className="text-sm font-mono text-amber-400">0.35 SOL</p>
                  </div>
                  <div>
                    <p className="text-[10px] text-text-tertiary">Savings</p>
                    <p className="text-sm font-mono text-success">0.15 SOL</p>
                  </div>
                </div>
              </div>
              <div className="p-3 rounded-lg bg-bg-tertiary border border-rust/20">
                <p className="text-xs text-text-primary mb-2 font-medium">10 Draft entries @ 1 SOL</p>
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div>
                    <p className="text-[10px] text-text-tertiary">Base</p>
                    <p className="text-sm font-mono text-danger">1.0 SOL</p>
                  </div>
                  <div>
                    <p className="text-[10px] text-text-tertiary">With Perk</p>
                    <p className="text-sm font-mono text-purple-400">0.7 SOL</p>
                  </div>
                  <div>
                    <p className="text-[10px] text-text-tertiary">Savings</p>
                    <p className="text-sm font-mono text-success">0.3 SOL</p>
                  </div>
                </div>
              </div>
              <div className="p-3 rounded-lg bg-accent/10 border border-accent/30">
                <p className="text-xs text-text-primary mb-2 font-bold">Monthly Active Player</p>
                <div className="grid grid-cols-3 gap-2 text-center">
                  <div>
                    <p className="text-[10px] text-text-tertiary">Base</p>
                    <p className="text-sm font-mono text-danger">~5 SOL</p>
                  </div>
                  <div>
                    <p className="text-[10px] text-text-tertiary">With Perk</p>
                    <p className="text-sm font-mono text-accent">~3.5 SOL</p>
                  </div>
                  <div>
                    <p className="text-[10px] text-text-tertiary">Savings</p>
                    <p className="text-sm font-mono text-success font-bold">~1.5 SOL</p>
                  </div>
                </div>
              </div>
            </div>
